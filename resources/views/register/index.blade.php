...
<div class="row justify-content-center" style="height: 80vh; margin-top:100px">
  <div class="col-lg-5">
    <main class="form-registration">
      ...
      <form action="/register" method="POST">
        ...
        <div class="input-group">
          <span class="input-group-text rounded-0" style="width: 10%">+62</span>
          <div class="form-floating" style="width: 90%;">
            <input type="text" name="phone" class="form-control @error('phone')
            is-invalid 
          @enderror" id="phone" placeholder="phone" required value="{{ old('phone') }}">
